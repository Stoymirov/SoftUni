...
namespace _02.SleepyTomCat
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int playingInActiveDays = (365 - restDays) * 63;
            int total = playInRestDays + playingInActiveDays;
            if (total > 30000)
            {
                Console.WriteLine("Tom will run away");
                Console.WriteLine($"{(total - 30000) / 60} hours and {(total - 30000) % 60} minutes more for play");
            }
            else
            {
                Console.WriteLine("Tom sleeps well");
                Console.WriteLine($"{(30000 - total) / 60} hours and {Math.Abs((30000 - total) % 60)} minutes less for play");
            }
